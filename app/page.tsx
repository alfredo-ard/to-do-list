...
export default function Home() {
    ...
    return (
        <div>
            <div className="min-h-[90vh] bg-slate-200 font-[inter] relative">
                <nav className="font-[serif] bg-teal-500 px-5 py-2 border-red-300 mb-10">
                    <h1 className="font-semibold text-3xl tracking-[3px]">
                        list
                    </h1>
                </nav>
            ...
            <div className="w-full bg-teal-500 h-20 shadow text-center p-5">
